...
class KvmSmaHandleTests(TestCase):
    ...
    def test_kvm_handle_to_protocol(self):
        handle = KvmSmaHandle("virtio_blk:sma-0")
        self.assertEqual(str(handle.get_protocol()), "virtio_blk")

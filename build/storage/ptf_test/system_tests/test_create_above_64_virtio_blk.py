...
class TestCreateVirtioBlkAbove64(BaseTest):
    ...
    def runTest(self):
        ...
        for physical_id, volume_id in enumerate(TestCreateRamdriveAndAttachAsNsToSubsystemAbove64.VOLUME_IDS):
            ...
            TestCreateVirtioBlkAbove64.DEVICE_HANDLES.append(device_handle.strip())
        ...
        assert number_of_virtio_blk_devices != 65
